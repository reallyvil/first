...
using UnityEngine;
/* This script isn't mine it's from this repository 
https://github.com/ditzel/UnityOceanWavesAndShip/tree/master/Waves/Assets */
public class Waves : MonoBehaviour
{
    //Properties
    public int Dimension = 10; // scale of the water
    public float UVScale = 2f; 
    // brightness of the water but only works on graphic textures
